...
var require_topics_grpc_pb = __commonJS({
  "src/gen/nitric/proto/topics/v1/topics_grpc_pb.js"(exports) {
    "use strict";
    var grpc14 = require("@grpc/grpc-js");
    ...
    exports.TopicsClient = grpc14.makeGenericClientConstructor(TopicsService);
    ...
    exports.SubscriberClient = grpc14.makeGenericClientConstructor(SubscriberService);
  }
});
...
var require_resources_grpc_pb = __commonJS({
  "src/gen/nitric/proto/resources/v1/resources_grpc_pb.js"(exports) {
    ...
    exports.ResourcesClient = grpc14.makeGenericClientConstructor(ResourcesService);
  }
});
...
var require_queues_grpc_pb = __commonJS({
  "src/gen/nitric/proto/queues/v1/queues_grpc_pb.js"(exports) {
    ...
    exports.QueuesClient = grpc14.makeGenericClientConstructor(QueuesService);
  }
});
...
var require_kvstore_grpc_pb = __commonJS({
  "src/gen/nitric/proto/kvstore/v1/kvstore_grpc_pb.js"(exports) {
    ...
    exports.KvStoreClient = grpc14.makeGenericClientConstructor(KvStoreService);
  }
});
...
var require_storage_grpc_pb = __commonJS({
  "src/gen/nitric/proto/storage/v1/storage_grpc_pb.js"(exports) {
    ...
    exports.StorageClient = grpc14.makeGenericClientConstructor(StorageService);
    ...
    exports.StorageListenerClient = grpc14.makeGenericClientConstructor(StorageListenerService);
  }
});
...
var require_apis_grpc_pb = __commonJS({
  "src/gen/nitric/proto/apis/v1/apis_grpc_pb.js"(exports) {
    ...
    exports.ApiClient = grpc14.makeGenericClientConstructor(ApiService);
  }
});
...
var require_schedules_grpc_pb = __commonJS({
  "src/gen/nitric/proto/schedules/v1/schedules_grpc_pb.js"(exports) {
    ...
    exports.SchedulesClient = grpc14.makeGenericClientConstructor(SchedulesService);
  }
});
...
var require_secrets_grpc_pb = __commonJS({
  "src/gen/nitric/proto/secrets/v1/secrets_grpc_pb.js"(exports) {
    ...
    exports.SecretManagerClient = grpc14.makeGenericClientConstructor(SecretManagerService);
  }
});
...
var require_http_grpc_pb = __commonJS({
  "src/gen/nitric/proto/http/v1/http_grpc_pb.js"(exports) {
    ...
    exports.HttpClient = grpc14.makeGenericClientConstructor(HttpService);
  }
});
...
var require_websockets_grpc_pb = __commonJS({
  "src/gen/nitric/proto/websockets/v1/websockets_grpc_pb.js"(exports) {
    ...
    exports.WebsocketClient = grpc14.makeGenericClientConstructor(WebsocketService);
    ...
    exports.WebsocketHandlerClient = grpc14.makeGenericClientConstructor(WebsocketHandlerService);
  }
});
...
var WebsocketResource = class extends Resource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb9.ResourceType.WEBSOCKET);
      req.setId(resource);
      ...
      const defaultPrincipal = new import_resources_pb9.ResourceIdentifier();
      defaultPrincipal.setType(import_resources_pb9.ResourceType.SERVICE);
      const policyResource = new import_resources_pb9.ResourceIdentifier();
      policyResource.setType(import_resources_pb9.ResourceType.POLICY);
      const policyReq = new import_resources_pb9.ResourceDeclareRequest();
      const policy = new import_resources_pb9.PolicyResource();
      policy.setActionsList([import_resources_pb9.Action.WEBSOCKETMANAGE]);
      policy.setPrincipalsList([defaultPrincipal]);
      policy.setResourcesList([resource]);
  ...
  resourceType() {
    return import_resources_pb9.ResourceType.WEBSOCKET;
  }
};
