...
declare class JobRequest$1 extends jspb.Message {
  getJobName(): string;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): JobRequest$1.AsObject;
  static toObject(includeInstance: boolean, msg: JobRequest$1): JobRequest$1.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: JobRequest$1, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): JobRequest$1;
  static deserializeBinaryFromReader(message: JobRequest$1, reader: jspb.BinaryReader): JobRequest$1;
}

declare namespace JobRequest$1 {
  export type AsObject = {
    jobName: string,
...
declare class JobData extends jspb.Message {
  hasStruct(): boolean;
  clearStruct(): void;
...
declare class JobResponse$1 extends jspb.Message {
  getSuccess(): boolean;
  setSuccess(value: boolean): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): JobResponse$1.AsObject;
  static toObject(includeInstance: boolean, msg: JobResponse$1): JobResponse$1.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: JobResponse$1, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): JobResponse$1;
  static deserializeBinaryFromReader(message: JobResponse$1, reader: jspb.BinaryReader): JobResponse$1;
}

declare namespace JobResponse$1 {
  export type AsObject = {
    success: boolean,
  }
}

declare class JobSubmitRequest extends jspb.Message {
  getJobName(): string;
  setJobName(value: string): void;
...
declare namespace JobSubmitRequest {
  export type AsObject = {
    jobName: string,
    data?: JobData.AsObject,
  }
...
declare class JobSubmitResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
...
declare namespace JobSubmitResponse {
  export type AsObject = {
  }
}
...
declare class JobRequest extends AbstractRequest {
    readonly jobName: string;
    constructor(data: string | Uint8Array, jobName: string);
}
declare class JobContext extends BaseContext<JobRequest, JobResponse> {
    get job(): JobContext;
    static fromJobRequest(jobRequest: JobRequest$1): JobContext;
    static toJobResponse(ctx: JobContext): JobResponse$1;
}
...
type JobMiddleware = GenericMiddleware<JobContext>;
/**
 * createHandler
 *
...
declare class TopicResource<T extends Record<string, any> = Record<string, any>> extends SecureResource<TopicPermission> {
     ...
     */
    for(perm: TopicPermissionLegacy, ...perms: TopicPermissionLegacy[]): Topic<T>;
    allow(perm: TopicPermission, ...perms: TopicPermission[]): Topic<T>;
}
/**
...
declare class QueueResource<T extends Record<string, any> = Record<string, any>> extends SecureResource<QueuePermission> {
    ...
    allow(perm: QueuePermission, ...perms: QueuePermission[]): Queue<T>;
}
/**
...
declare class KeyValueStoreResource<T extends ValueStructure> extends SecureResource<StorePermission> {
     ...
     */
    for(perm: StorePermissionLegacy, ...perms: StorePermissionLegacy[]): StoreRef<T>;
    /**
     * Return a key/value store reference and register the permissions required by the currently scoped service for this resource.
     *
     * e.g. const customers = resources.kv('customers').for('getting', 'setting')
     ...
     * @returns a usable key/value store reference
     */
    allow(perm: StorePermission, ...perms: StorePermission[]): StoreRef<T>;
}
/**
...
declare class BucketResource extends SecureResource<BucketPermission> {
     ...
     */
    for(perm: BucketPermissionLegacy, ...perms: BucketPermissionLegacy[]): Bucket;
    /**
     * Return a bucket reference and register the permissions required by the currently scoped function for this resource.
     *
     * e.g. const imgs = resources.bucket('image').for('writing')
     ...
     * @returns a usable bucket reference
     */
    allow(perm: BucketPermission, ...perms: BucketPermission[]): Bucket;
}
/**
...
declare class SecretResource extends SecureResource<SecretPermission> {
    ...
    protected resourceType(): ResourceTypeMap[keyof ResourceTypeMap];
    for(perm: SecretPermissionLegacy, ...perms: SecretPermissionLegacy[]): Secret;
    allow(perm: SecretPermission, ...perms: SecretPermission[]): Secret;
}
/**
 ...
 */
declare class SQLDatabaseResource extends Resource {
...
declare class BatchClient extends grpc.Client {
  constructor(address: string, credentials: grpc.ChannelCredentials, options?: object);
  submitJob(argument: JobSubmitRequest, callback: grpc.requestCallback<JobSubmitResponse>): grpc.ClientUnaryCall;
  submitJob(argument: JobSubmitRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<JobSubmitResponse>): grpc.ClientUnaryCall;
  submitJob(argument: JobSubmitRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<JobSubmitResponse>): grpc.ClientUnaryCall;
}

declare class Job<T extends Record<string, any> = Record<string, any>> {
    private name;
    private client;
...
declare class JobHandler {
    private readonly jobName;
    private readonly handler;
    private readonly requirements;
    constructor(jobName: string, requirements: JobResourceRequirements, ...middleware: JobMiddleware[]);
    private start;
}
declare class JobResource extends SecureResource<JobPermission> {
    constructor(name: string);
    protected register(): Promise<ResourceIdentifier>;
    protected permsToActions(...perms: JobPermission[]): ActionMap[keyof ActionMap][];
    protected resourceType(): ResourceTypeMap[keyof ResourceTypeMap];
    /**
 ...
 */
declare const job: (name: string) => JobResource;
...
declare class Thread {
    ...
    constructor(id: string, model: string, history: ChatHistory, memory: StoreRef<ChatHistory>, openai: OpenAI, tools: Record<string, ToolConfig>);
    private send;
    private save;
}
declare class Chat {
